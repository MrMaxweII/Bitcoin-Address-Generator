...
private int getFormat(String str)
{
	...
	if(str.length()==64 && 	str.matches("[0-9a-fA-F]+")) 				 return 16;	
	if(str.matches("[123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz]+")) return 58;	
	if(str.length()==109 && str.matches("[123456-]+")) 				 return 6;	
	return -1;
}
