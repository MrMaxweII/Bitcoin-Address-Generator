...
*	Info: Die Verbindung mit dem Web dient dazu den BTC-Betrag von generieren Adressen schnell anzuzeigen.	*
*	Und per Link schnell die Adresse in einem Blockexplorer aufzurufen.										*
*	Dies erleichtert das finden von Beträgen und wird zu u.A. zu testzwecken verwendet.						*
*	Der CoinAdressGenerator sollte im regulärem Betrieb nur auf Offline-PC´s verwendet werden!				*
*************************************************************************************************************/
...
// Blockchain.info geht nicht mehr
