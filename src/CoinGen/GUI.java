...
public class GUI extends JFrame 
{
	...
	public static JEditorPane 		txt_ausgabe 	= new JEditorPane("text/html","plain");
...
public GUI() throws ParseException 
{
	...
	JMenuItem 	mItem_newCoin 	= new JMenuItem("add new Coin");
...
// ----------------------------------------------------------- ActionListeners -------------------//
	...
	p2sh.addChangeListener(new ChangeListener() 
	{
		public void stateChanged(ChangeEvent arg0) {Action.go();}
	});
	
	unCompressed.addChangeListener(new ChangeListener() 
	{
		public void stateChanged(ChangeEvent arg0) {Action.go();}
	});
	
	bech32.addChangeListener(new ChangeListener() 
	{
		public void stateChanged(ChangeEvent arg0) {Action.go();}
	});	
...
{
	if(name.equals("unCompressed")) unCompressed.doClick();
	if(name.equals("compressed")) 	compressed.doClick();	
	if(name.equals("p2sh")) 		p2sh.doClick();
	if(name.equals("bech32")) 		bech32.doClick();
}
}
