...
/****************************************************************************************************************************
*		V2.1    					Autor: Mr. Maxwell   							vom 04.12.2025							*
*	 	LIB3001 Bibliotheks Klasse																							*
*		Letzte Änderung: isSigned() hinzugefügt.																		 	*
...
/**	Gibt true zurück, wenn ein bekanntes SignaturScript gefunden wurde.
	die Signatur wird nicht verifiziert, es wird nur auf "Vorhanden Sein" geprüft!
	Bei allen unbekannten Scripts oder bei null wird false zurückgegeben.
	Kann benutzt werden um zu prüfen ob es sich um eine Signierte Transaktion handelt oder nicht.**/
