...
/**	@param hash160 Dem Konstruktor wird die BitcoinAdresse als Hash160 20 Byte-Array übergeben.
	@param pref_pubKey Das Präfix aus den CoinParametern für die Bitcoin Adresse:  Bitcoin-MainNet=0x00, Bitcoin-TestNet=0x6f**/
...
/**	@param prefix_P2SH Es muss das P2SH-Prefix als Zahlen-String (so wie es aus den CoinParametern kommt) übergeben werden. Bitcoin-MainNet=0x05, Bitcoin-TestNet=0xc4;
...
// Zurück gegeben wird das "RedeemScript" welches dem neuem Hash160 entspricht, der dann so in eine Base58 Adresse codiert werden kann.
